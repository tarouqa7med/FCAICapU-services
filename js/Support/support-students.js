...
document.addEventListener('DOMContentLoaded', async () => {
    const category = document.querySelector('.support').dataset.category || 'students';
            ...
            (data.projects || []).slice(0, 4).forEach((project, index) => {
                ...
                projectsHtml += `
                    <div class="s-box">
                        ...
                        <div class="div1">
                            <img src="${imgSrc}" alt="${project.name}" onerror="this.src='../attachments/wallpapers/halls.png'">
                            <div class="div2">
                                <div class="progress">
